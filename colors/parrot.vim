...
let g:colors_name="parrot"

hi Normal       guifg=#D3D7CF guibg=grey18
...
hi DiffDelete   gui=bold guibg=#CC0000 guifg=#282c34
hi DiffText     gui=none guibg=#C4A000
hi EndOfBuffer  gui=bold guifg=grey68
hi Folded       guibg=grey28 guifg=gold
hi FoldColumn   guibg=grey28 guifg=tan
hi IncSearch    guibg=grey36 gui=none guifg=#D3D7CF
hi LineNr       guifg=#CC0000 guibg=grey28
hi LineNr       ctermfg=Red ctermbg=DarkGray gui=none
hi MatchParen   guibg=#06989A guifg=grey18
...
hi Title        guifg=#FCE94F gui=none
...
hi TagbarVisibilityProtected guifg=#06989A gui=bold
hi TagbarVisibilityPrivate   guifg=#EF2929 gui=bold
hi TagbarVisibilityPublic    guifg=#4E9A06 gui=bold
